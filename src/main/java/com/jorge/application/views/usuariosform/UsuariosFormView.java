package com.jorge.application.views.usuariosform;
...
@PageTitle("Usuarios Form")
@Route(value = "usuarios-form", layout = MainLayout.class)
@Uses(Icon.class)
public class UsuariosFormView extends Div {
    ...
    public UsuariosFormView(SamplePersonService personService) {
        addClassName("usuarios-form-view");
